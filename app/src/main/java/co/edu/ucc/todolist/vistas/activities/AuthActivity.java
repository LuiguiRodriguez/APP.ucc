...
import co.edu.ucc.todolist.vistas.fragmentos.recuperarContrasenaFragment;
...
public class AuthActivity extends AppCompatActivity
        ...
        RegistroFragment.OnRegistroInteractionListener,recuperarContrasenaFragment.OnFragmentInteractionListener{
    ...
    @Override
    public void irARecordarPassword() {
        FragmentTransaction transaction =
                getSupportFragmentManager().beginTransaction();

        transaction.replace(R.id.frameAuthActivity, recuperarContrasenaFragment.newInstance());
        transaction.commit();
    }
